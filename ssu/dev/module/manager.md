...
<Accordion>
  <AccordionItem title="展开查看渲染效果">
    <img src="/assets/img/module_prop.webp" alt="module.prop 渲染效果" />
  </AccordionItem>
</Accordion>
...
<Footnote>
  ANSI 转义码是一种用于控制文本显示样式的字符编码方式，常用于终端和控制台应用程序中，详见<Link href="https://zh.wikipedia.org/wiki/ANSI%E8%BD%AC%E4%B9%89%E5%BA%8F%E5%88%97">维基百科</Link>
</Footnote>