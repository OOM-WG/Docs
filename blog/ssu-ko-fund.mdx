...
author: Linso
keywords: ['回忆溢出', 'ShiroSU', 'root', '内核', 'C-C++']
---
...
date=" 25 年 7 月 4 日 星期五"
/>

<Tip>SSU 内核是 SSU 的一部分，但其并非 SSU 的主要定位，其将会作为可选内容而存在</Tip>
...
<Tip><strong>伪代码，并非实际逻辑</strong></Tip>
...
- **UID/GID 提权**: 将当前进程的所有`用户`和`用户组`提权为 `root`=
...
<Tip>本文章所展示的代码为 ShiroSU 内核的部分<strong>伪代码</strong>，<strong>并非实际代码</strong>，<strong>与实际代码会有出入</strong>，<strong>伪代码仅供参考</strong></Tip>
