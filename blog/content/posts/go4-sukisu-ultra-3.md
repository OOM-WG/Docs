...
tags: [SukiSU Ultra, root, 内核, Android 开发, C-C++]
category: GO4
---
...
>
> 不过为了能够拉取上游，甚至使用到了 [Cursor](https://github.com/SukiSU-Ultra/SukiSU-Ultra/commit/39f4a5991a4b9b614a9fe2a56f13f9f8800c3943)，究竟是要完全跟随还是相对独立呢？
>
> > 对于 AI 的使用，可见 [此篇文章](../ai-for-root/)，AI 不是问题，
> > 不过 SukiSU Ultra 最大的问题是很多代码**根本看不出来**是 AI 写的还是人写的，
> > 因为正常人和正常 AI **都写不出来**这样的代码
>
