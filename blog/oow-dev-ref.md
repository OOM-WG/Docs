...
author: 白彩恋
keywords: ['回忆溢出', '开发', 'C-C++', 'Dart', 'FVV', 'Go', 'Kotlin', 'Shell']
---
...
<Tip>部分语言可能会冲突，可以适当"入乡随俗"<br />`Go` 的公开定义注意大写</Tip>
