...
export async function getAllCategories() {
	...
	const allCategories = newestPosts.reduce<{slug: string; name: string; count: number}[]>((acc, cur) => {
...
export async function getAllTags() {
	...
	const allTags = newestPosts.reduce<{slug: string; name: string; count: number}[]>((acc, cur) => {
